                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width:322px;">
                                ...
                                <a class="btn btn-success" href="/ordem/<?php echo htmlspecialchars( $value1["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" role="button">Boleto</a>
                                <a class="btn btn-info" href="/profile/orders/<?php echo htmlspecialchars( $value1["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" role="button">Detalhes</a> 
                                
                                <?php if( $value1["desstatus"] == 'Garantia' ){ ?>    
                                <a class="btn btn-warning" href="/profile/orders-maintenance/<?php echo htmlspecialchars( $value1["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" role="button">Manutenção</a>
                                <?php } ?>
